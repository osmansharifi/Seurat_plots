...
s.obj.name = "all.rett.combined" #change this to the name of the Seurat object you started with
...
save(DGEList, DGEList_high, DGEList_low, design, cell_types, file="DEanalysis_Mecp2_parsing_01.RData")
