...
DEG_data_dir <- "~/GitHub/snRNA-seq-pipeline/DEG_data/EdgeR/M_MUT_and_WT_M_E18_WB/"

# Lists
cell_types <- list("L5", "L4", "Pvalb", "Sncg", "Non_neuronal", "Oligo", "Vip", "Lamp5", "Astro", "Peri", "Endo") 
# "L2_3_IT", "L6", "Sst", 
