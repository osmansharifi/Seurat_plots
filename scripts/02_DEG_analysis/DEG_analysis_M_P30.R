...
write.csv(L2_3_IT_toptable, file = "/Users/osman/Documents/GitHub/snRNA-seq-pipeline/DEG_data/all_genes/L2_3_IT_limma_top_1000.csv")
L2_3_IT_Limma_stat_sig <- subset(x = L2_3_IT_toptable, subset = adj.P.Val < 0.05)
write.csv(L2_3_IT_Limma_stat_sig, file = "/Users/osman/Documents/GitHub/snRNA-seq-pipeline/DEG_data/stat_sig/L2_3_IT_Limma_DEG_only_stat_sig.csv")
...
write.csv(L6_toptable, file = "/Users/osman/Documents/GitHub/snRNA-seq-pipeline/DEG_data/all_genes/L6_limma_top_1000.csv")
L6_Limma_stat_sig <- subset(x = L6_toptable, subset = adj.P.Val < 0.05)
write.csv(L6_Limma_stat_sig, file = "/Users/osman/Documents/GitHub/snRNA-seq-pipeline/DEG_data/stat_sig/L6_Limma_DEG_only_stat_sig.csv")
...
write.csv(Sst_toptable, file = "/Users/osman/Documents/GitHub/snRNA-seq-pipeline/DEG_data/all_genes/Sst_limma_top_1000.csv")
Sst_Limma_stat_sig <- subset(x = Sst_toptable, subset = adj.P.Val < 0.05)
write.csv(Sst_Limma_stat_sig, file = "/Users/osman/Documents/GitHub/snRNA-seq-pipeline/DEG_data/stat_sig/Sst_Limma_DEG_only_stat_sig.csv")
...
write.csv(L5_toptable, file = "/Users/osman/Documents/GitHub/snRNA-seq-pipeline/DEG_data/all_genes/L5_limma_top_1000.csv")
L5_Limma_stat_sig <- subset(x = L5_toptable, subset = adj.P.Val < 0.05)
write.csv(L5_Limma_stat_sig, file = "/Users/osman/Documents/GitHub/snRNA-seq-pipeline/DEG_data/stat_sig/L5_Limma_DEG_only_stat_sig.csv")
...
write.csv(L4_toptable, file = "/Users/osman/Documents/GitHub/snRNA-seq-pipeline/DEG_data/all_genes/L4_limma_top_1000.csv")
L4_Limma_stat_sig <- subset(x = L4_toptable, subset = adj.P.Val < 0.05)
write.csv(L4_Limma_stat_sig, file = "/Users/osman/Documents/GitHub/snRNA-seq-pipeline/DEG_data/stat_sig/L4_Limma_DEG_only_stat_sig.csv")
...
write.csv(Pvalb_toptable, file = "/Users/osman/Documents/GitHub/snRNA-seq-pipeline/DEG_data/all_genes/Pvalb_limma_top_1000.csv")
Pvalb_Limma_stat_sig <- subset(x = Pvalb_toptable, subset = adj.P.Val < 0.05)
write.csv(Pvalb_Limma_stat_sig, file = "/Users/osman/Documents/GitHub/snRNA-seq-pipeline/DEG_data/stat_sig/Pvalb_Limma_DEG_only_stat_sig.csv")
...
write.csv(Sncg_toptable, file = "/Users/osman/Documents/GitHub/snRNA-seq-pipeline/DEG_data/all_genes/Sncg_limma_top_1000.csv")
Sncg_Limma_stat_sig <- subset(x = Sncg_toptable, subset = adj.P.Val < 0.05)
write.csv(Sncg_Limma_stat_sig, file = "/Users/osman/Documents/GitHub/snRNA-seq-pipeline/DEG_data/stat_sig/Sncg_Limma_DEG_only_stat_sig.csv")
...
write.csv(Non_neuronal_toptable, file = "/Users/osman/Documents/GitHub/snRNA-seq-pipeline/DEG_data/all_genes/Non_neuronal_limma_top_1000.csv")
Non_neuronal_Limma_stat_sig <- subset(x = Non_neuronal_toptable, subset = adj.P.Val < 0.05)
write.csv(Non_neuronal_Limma_stat_sig, file = "/Users/osman/Documents/GitHub/snRNA-seq-pipeline/DEG_data/stat_sig/Non_neuronal_Limma_DEG_only_stat_sig.csv")
...
L2_3_IT_Limma_stat_sig <- read.csv(file = "~/GitHub/snRNA-seq-pipeline/DEG_data/Limma/L2_3_IT_M_MUT_and_WT_M_P30_CORT_Limma_DEG.csv")
L6_Limma_stat_sig <- read.csv(file = "~/GitHub/snRNA-seq-pipeline/DEG_data/Limma/L6_M_MUT_and_WT_M_P30_CORT_Limma_DEG.csv")
Sst_Limma_stat_sig <- read.csv(file = "~/GitHub/snRNA-seq-pipeline/DEG_data/Limma/Sst_M_MUT_and_WT_M_P30_CORT_Limma_DEG.csv")
L5_Limma_stat_sig <- read.csv(file = "~/GitHub/snRNA-seq-pipeline/DEG_data/Limma/L5_M_MUT_and_WT_M_P30_CORT_Limma_DEG.csv")
L4_Limma_stat_sig <- read.csv(file = "~/GitHub/snRNA-seq-pipeline/DEG_data/Limma/L4_M_MUT_and_WT_M_P30_CORT_Limma_DEG.csv")
Pvalb_Limma_stat_sig <- read.csv(file = "~/GitHub/snRNA-seq-pipeline/DEG_data/Limma/Pvalb_M_MUT_and_WT_M_P30_CORT_Limma_DEG.csv")
Sncg_Limma_stat_sig <- read.csv(file = "~/GitHub/snRNA-seq-pipeline/DEG_data/Limma/Sncg_M_MUT_and_WT_M_P30_CORT_Limma_DEG.csv")
Non_neuronal_Limma_stat_sig <- read.csv(file = "~/GitHub/snRNA-seq-pipeline/DEG_data/Limma/Non_neuronal_M_MUT_and_WT_M_P30_CORT_Limma_DEG.csv")
Oligo_Limma_stat_sig <- read.csv(file = "~/GitHub/snRNA-seq-pipeline/DEG_data/Limma/Oligo_M_MUT_and_WT_M_P30_CORT_Limma_DEG.csv")
Vip_Limma_stat_sig <- read.csv(file = "~/GitHub/snRNA-seq-pipeline/DEG_data/Limma/Vip_M_MUT_and_WT_M_P30_CORT_Limma_DEG.csv")
Lamp5_Limma_stat_sig <- read.csv(file = "~/GitHub/snRNA-seq-pipeline/DEG_data/Limma/Lamp5_M_MUT_and_WT_M_P30_CORT_Limma_DEG.csv")
Astro_Limma_stat_sig <- read.csv(file = "~/GitHub/snRNA-seq-pipeline/DEG_data/Limma/Astro_M_MUT_and_WT_M_P30_CORT_Limma_DEG.csv")
Peri_Limma_stat_sig <- read.csv(file = "~/GitHub/snRNA-seq-pipeline/DEG_data/Limma/Peri_M_MUT_and_WT_M_P30_CORT_Limma_DEG.csv")
Endo_Limma_stat_sig <- read.csv(file = "~/GitHub/snRNA-seq-pipeline/DEG_data/Limma/Endo_M_MUT_and_WT_M_P30_CORT_Limma_DEG.csv")
