...
# Paths
EdgeR_DEG_dir <- "~/GitHub/snRNA-seq-pipeline/DEG_data/EdgeR/M_MUT_and_WT_M_E18_WB/"
DESeq2_DEG_dir <- "~/GitHub/snRNA-seq-pipeline/DEG_data/DESeq2/M_MUT_and_WT_M_E18_WB/"
Limma_DEG_dir <- "~/GitHub/snRNA-seq-pipeline/DEG_data/Limma/M_MUT_and_WT_M_E18_WB/"

venn_dir <- "~/GitHub/snRNA-seq-pipeline/figures/venn_diagrams/M_MUT_and_WT_M_E18_WB/"
...
subtitle_info <- "Mice, Male, E18, Whole Brain"
...
ggsave("L2_3_IT_M_MUT_and_WT_M_E18_WB_venn.pdf", device = "pdf", path = venn_dir)
...
L6_venn <- ggVennDiagram(L6_venn_list, color = "black", lwd = 0.8, lty = 1, category.names = c("Limma", "EdgeR", "DESeq2")) +
  ...
  theme(plot.title = element_text(hjust = 0.5))
ggsave("L6_M_MUT_and_WT_M_E18_WB_venn.pdf", device = "pdf", path = venn_dir)
