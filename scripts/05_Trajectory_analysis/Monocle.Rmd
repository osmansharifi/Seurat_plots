...
```{r pseudotime}
cds_WT <- order_cells(cds_WT, root_pr_nodes = NULL, root_cells = colnames(cds_WT[,clusters(cds_WT) == "Peri"]))
...
cds_MUT <- order_cells(cds_MUT, root_pr_nodes = NULL, root_cells = colnames(cds_MUT[,clusters(cds_MUT) == "Peri"]))
