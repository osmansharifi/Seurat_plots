...
monocle_clusters <- cds@clusters@listData$UMAP$clusters
cds@clusters@listData$UMAP$clusters <- trA.integrated$seurat_clusters

p1 <- plot_cells(cds, color_cells_by = "orig.ident", show_trajectory_graph = FALSE)
p2 <- plot_cells(cds, color_cells_by = "partition", show_trajectory_graph = FALSE)
p3 <- plot_cells(cds, color_cells_by = "celltype.call", show_trajectory_graph = FALSE)
wrap_plots(p1, p2, p3)
ggplot2::ggsave("P30_M_monocle_partition_highres.pdf",
                device = NULL,
                height = 8.5,
                width = 12)
...
cds@clusters@listData$UMAP$clusters <- trA.integrated$orig.ident # play with labeling of cells 
cds@clusters@listData$UMAP$clusters <- trA.integrated$celltype.call
plot_cells(cds,
...
```{r pseudotime}
cds <- order_cells(cds, root_pr_nodes = NULL, root_cells = colnames(cds[,clusters(cds) == "Oligo"]))
plot_cells(cds,
