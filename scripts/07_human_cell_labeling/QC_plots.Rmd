...
```{r echo=FALSE}
# All functions contain 
p1 <- QC_Plots_Genes(seurat_object = human_rettcort, low_cutoff = 800, high_cutoff = 5500, pt.size = 0.1)
p2 <- QC_Plots_UMIs(seurat_object = human_rettcort, low_cutoff = 1200, high_cutoff = 45000, pt.size = 0.1)
p3 <- QC_Plots_Mito(seurat_object = human_rettcort, high_cutoff = 20, pt.size = 0.1)
```
...
```{r eval=FALSE}
# All functions contain 
QC_Plot_UMIvsGene(seurat_object = human_rettcort, low_cutoff_gene = 800, high_cutoff_gene = 5500, low_cutoff_UMI = 500, high_cutoff_UMI = 50000)
QC_Plot_GenevsFeature(seurat_object = human_rettcort, feature1 = "percent_mito", low_cutoff_gene = 800, high_cutoff_gene = 5500, high_cutoff_feature = 20)
```

```{r echo=FALSE, fig.height=7, fig.width=13, fig.align='center'}
# All functions contain 
p1 <- QC_Plot_UMIvsGene(seurat_object = human_rettcort, low_cutoff_gene = 400, high_cutoff_gene = 5500, low_cutoff_UMI = 1200, high_cutoff_UMI = 45000, x_axis_label = "UMIs per Cell")
p2 <- QC_Plot_GenevsFeature(seurat_object = human_rettcort, feature1 = "percent_mito", low_cutoff_gene = 800, high_cutoff_gene = 5500, high_cutoff_feature = 20)
...
QC_Plot_UMIvsGene(seurat_object = human_rettcort, meta_gradient_name = "percent_mito", low_cutoff_gene = 800, high_cutoff_gene = 5500, high_cutoff_UMI = 45000, meta_gradient_low_cutoff = 20)
```
...
p1 <- QC_Plot_UMIvsGene(seurat_object = human_rettcort, meta_gradient_name = "percent_mito", low_cutoff_gene = 800, high_cutoff_gene = 5500, high_cutoff_UMI = 45000)
p2 <- QC_Plot_UMIvsGene(seurat_object = human_rettcort, meta_gradient_name = "percent_mito", low_cutoff_gene = 800, high_cutoff_gene = 5500, high_cutoff_UMI = 45000, meta_gradient_low_cutoff = 20)
...
QC_Plot_UMIvsGene(seurat_object = human_rettcort, meta_gradient_name = "percent_mito", low_cutoff_gene = 800, high_cutoff_gene = 5500, high_cutoff_UMI = 45000, meta_gradient_low_cutoff = 20, combination = TRUE)
```
...
```{r}
median_stats <- Median_Stats(seurat_object = human_rettcort, group_by_var = "orig.ident")
```
...
```{r eval=FALSE}
Plot_Median_Genes(seurat_object = human_rettcort, group_by = "group")
Plot_Median_UMIs(seurat_object = human_rettcort, group_by = "group")
Plot_Median_Mito(seurat_object = human_rettcort, group_by = "group")
Plot_Median_Other(seurat_object = human_rettcort, median_var = "percent_ribo", group_by = "group")
```
