...
Idents(human_rettcort) <- "predicted.subcluster"
# Rename classes.
human_rettcort <- RenameIdents(object = human_rettcort, `L2/3 IT` = "your cell type", `1` = "your other cell type", `2` = "your last cell type")
